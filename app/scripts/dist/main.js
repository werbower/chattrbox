...
var ChatApp = function ChatApp() {
  ...
  _wsClient2.default.registerMessageHandler(function (data) {
    ...
    var msg = new ChatMessage(data);
    _this.chatList.drawMessage(msg.serialize());
  });
};
